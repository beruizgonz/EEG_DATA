...
def main():
    ...
    eeg = os.path.join(os.getcwd(), 'data/LEMON-mask-4s-8channel1.h5')
    ...
    pretext = SSL_EEG(learning_rate=0.001, encoder_args=encoder_args, decoder = MaskedDecoder(d_model=64, feat_dim =8), loss_fn=MaskedMSELoss())
