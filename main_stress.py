...
ckpt = os.path.join('checkpoints', 'SSL-4s-val_loss=0.39-epoch=45.ckpt')
...
encoder_args = {'feat_dim': 8, 'seq_len':512, 'd_model':128, 'n_heads': 8, 'num_layers': 3, 'dim_feedforward': 256, 'dropout': 0.1, 'activation': 'gelu', 'norm': 'BatchNorm'}
